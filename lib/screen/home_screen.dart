    ...
    return ListView(
      children: [
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: shared.blackTextFont.copyWith(fontSize: 18),
              ),
              SizedBox(
                height: 14,
              ),
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(color: Color(0xFFEBEAEA))),
                      suffixIcon: Icon(
                        Icons.search,
                        size: 24,
        ...
        Container(
          ...
          child: BlocBuilder<FoodRecipeBloc, FoodRecipeState>(
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        context
                            ...
                            .bloc<PageBloc>()
                            .add(GoToRecipeDetail(id: foodRecipes[index].id));
                      },
                    );
                  });
            } else {
        ...
        SizedBox(
          height: 24,
            ...
            BlocBuilder<FoodRecipeBloc, FoodRecipeState>(
          builder: (context, state) {
            if (state is FoodRecipeLoaded) {
              List<FoodRecipeModel> foodRecipes =
